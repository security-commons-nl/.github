...
| [ai-gebruik-in-beeld](https://github.com/security-commons-nl/ai-gebruik-in-beeld) | Actief | Draaiboek om AI-gebruik in de organisatie feitelijk te meten (CISO + FG): meetregimes, bronnen met bewijslast, run-log, plus 15 KQL-query's | CISO's, FG's en securityteams bij publieke organisaties |
