...
|---|---|---|---|
| [kennisbank](https://github.com/security-commons-nl/kennisbank) | Actief | Werkende kennis uit de publieke sector, security, privacy, continuïteit en alles wat er tussen zit — open de [online kennisbank](https://security-commons-nl.github.io/kennisbank/) | Security-, privacy- en continuïteitsprofessionals |
...
| [weerbaarheid-game](https://github.com/security-commons-nl/weerbaarheid-game) | Actief | Interactief bestuursdashboard dat de digitale kwetsbaarheid van een organisatie zichtbaar maakt — open het [live dashboard](https://security-commons-nl.github.io/weerbaarheid-game/) | College van B&W, directies, bestuurders |
