...
| [security-posture-tool](https://github.com/security-commons-nl/security-posture-tool) | prototype | Evidence-based security posture langs Defense-in-Depth | — | Blue teams en interventieteams |
