...
| [normen](https://github.com/security-commons-nl/normen) | in gebruik | De normbronnen als dataset: BIO 2.0 (148 overheidsmaatregelen met tekst en risico), NIST CSF 2.0, het Wpg-toetsingskader en de AVG, elk als één JSON in één schema met herkomst en vingerafdruk. Zonder ISO-tekst. De aanvalspaden en applicatiecheck lezen hieruit; wie een norm in een tool wil laden, hoeft hem niet meer uit een PDF te halen | [Leesbare versie](https://security-commons-nl.github.io/normen/) | Bouwers van instrumenten, en CISO's, ISO's en privacy officers die een norm willen doorzoeken of hergebruiken |

**Gearchiveerd:** [grc-platform](https://github.com/security-commons-nl/grc-platform) (ISMS/PIMS/BCMS-applicatie;
