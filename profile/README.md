...
| [csir-control-register](https://github.com/security-commons-nl/csir-control-register) | prototype | Excel-werkboek dat de CSIR (Cybersecurity Implementatierichtlijn Objecten) toepast op één object met industriële automatisering: functiebox naar weerstandsniveau, en daaruit de 127 controls en 268 maatregelen die op dat niveau gelden, woordelijk uit de richtlijn. Met live voortgang, scope-logica en een dashboard; bruikbaar als eisenbron bij aanbesteding en contract | [Leesbare versie](https://security-commons-nl.github.io/csir-control-register/) | CISO's, ISO's, objectbeheerders en projectleiders bij publieke organisaties die tunnels, gemalen, bruggen of sluizen beheren |
