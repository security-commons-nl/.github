...
| [2026-09-02-elk-project-een-pagina.md](2026-09-02-elk-project-een-pagina.md) | B13 uitrollen: de tien projecten zonder pagina een leesversie geven, en de gedeelde site-build op één plek | wacht op uitvoering |
| [2026-09-02-applicatiecheck.md](2026-09-02-applicatiecheck.md) | Applicatiecheck: één gekochte applicatie tegen BIO2 uit configuratie-export en logsample; bewijsmodel A/B/C/D, regels als data, dossier per maatregel; eerste toepassing een zaaksysteem | F0 uitgevoerd; deel 2 is het uitvoeringsplan voor F1 t/m F4, stap voor stap, ook voor een minder sterk model |
| [2026-09-02-lichte-commons.md](2026-09-02-lichte-commons.md) | Geen applicaties meer: het criterium instrument-of-script, de vaste vorm, per repo een oordeel (grc-platform neemt afscheid) en de volgorde van ombouwen | besloten, fase 0 |
| [2026-09-02-normen.md](2026-09-02-normen.md) | Eén dataset-repo voor de normbronnen (BIO 2.0, NIST CSF 2.0, Wpg, AVG): één schema, een vingerafdruk, afnemers kopiëren met een `--check` | uitgevoerd, op applicatiecheck (#2) en cisochat na |
...
| [2026-09-03-meting.md](2026-09-03-meting.md) | Meting als instrument in aanvalspaden/meting/: 41 meetregels op exports en de Linux-dump van iamscan, bewijs per chokepoint, witte vlekken hardop; posture-tool en iamscan gaan erin op | in uitvoering |
| [2026-09-03-ontvlechting-voorpagina-en-werkplaats.md](2026-09-03-ontvlechting-voorpagina-en-werkplaats.md) | Ontvlechting van voorpagina (github.io) en werkplaats (github.com): profiel-README afslanken tot 25 regels, projectenlijst naar PROJECTEN.md, statuut B9 en website vernieuwen | in uitvoering |
| [2026-09-03-dpiacheck.md](2026-09-03-dpiacheck.md) | `dpiacheck`: de DPIA-plicht toetsen aan de openbare criteria, uit één maatregelencatalogus tonen wat bij een soort verwerking hoort, en een concept-DPIA uitdraaien waarin elk voorstel zijn herkomst draagt; AI kiest uit de catalogus en verzint niets; de oogst uit uitgevoerde DPIA's is fase O, cameratoezicht eerst | vastgesteld, wacht op uitvoering |
